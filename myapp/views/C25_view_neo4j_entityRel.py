...
def entityRelNeo4jFunc(request):
    logger.info(f"********************************************************************************************************************************************************************************************")
    logger.info("This is an entityRelNeo4jFunc view and C25_neo4j_entityRel.html")
    ...
    if request.method == 'POST':
        ...
        return render(request, 'C25_neo4j_entityRel.html', {

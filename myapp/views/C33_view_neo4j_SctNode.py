...
def SctNodeNeo4jFunc(request):
    logger.info(f"********************************************************************************************************************************************************************************************")
    logger.info("This is an SctNodeNeo4jFunc view and C33_neo4j_SctNode.html")
    ...
    if request.method == 'POST':
        ...
        savingTxt4 = outDir + "/" + "Q4_short.txt"
        ...
        return render(request, 'C33_neo4j_SctNode.html', {

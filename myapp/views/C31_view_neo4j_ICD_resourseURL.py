...
svgDir = svgLoc + "/" + '05_ICD'
print(svgDir)

def seve_neo4jQuery_funcQ1_ICD(request):
...
def seve_neo4jQuery_funcQ2_ICD(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '05_ICD'
...
def seve_neo4jQuery_funcQ3_ICD(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '05_ICD'
...
def seve_neo4jQuery_funcQ4_ICD(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '05_ICD'
...
def seve_neo4jQuery_svgQ4_ICD(request):

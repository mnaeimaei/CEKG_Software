...
def otherEntitiesNeo4jFunc(request):
    logger.info(f"********************************************************************************************************************************************************************************************")
    logger.info("This is an otherEntitiesNeo4jFunc view and C23_neo4j_otherEntities.html")
    ...
    svgPath = downS + "/" + '02_OtherEntities'
    ...
    if request.method == 'POST':
        ...
        return render(request, 'C23_neo4j_otherEntities.html', {

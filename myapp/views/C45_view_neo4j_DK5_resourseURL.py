...
svgDir = svgLoc + "/" + '12_DK5'
print(svgDir)

def seve_neo4jQuery_funcQ1_DK5(request):
...
def seve_neo4jQuery_funcQ2_DK5(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '12_DK5'
...
def seve_neo4jQuery_funcQ3_DK5(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '12_DK5'
...
def seve_neo4jQuery_svgQ2_DK5(request):
...
def seve_neo4jQuery_svgQ3_DK5(request):

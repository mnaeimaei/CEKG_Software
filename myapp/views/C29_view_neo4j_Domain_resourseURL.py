...
svgDir = svgLoc + "/" + '04_Domain'
print(svgDir)

def seve_neo4jQuery_funcQ1_Domain(request):
...
def seve_neo4jQuery_funcQ2_Domain(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '04_Domain'
...
def seve_neo4jQuery_funcQ3_Domain(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '04_Domain'
...
def seve_neo4jQuery_funcQ4_Domain(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '04_Domain'
...
def seve_neo4jQuery_svgQ4_Domain(request):

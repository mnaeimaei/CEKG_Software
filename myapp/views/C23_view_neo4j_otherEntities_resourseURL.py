...
svgDir = svgLoc + "/" + '02_OtherEntities'
print(svgDir)


def seve_neo4jQuery_funcQ1_otherEntities(request):
...
def seve_neo4jQuery_funcQ2_otherEntities(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '02_OtherEntities'
...
def seve_neo4jQuery_funcQ3_otherEntities(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '02_OtherEntities'
...
def seve_neo4jQuery_funcQ4_otherEntities(request):
    username = request.user.username
    downloadDir = f'../../media/{username}/download/dfgTool'
    downD = os.path.realpath(downloadDir)
    outDir = downD + "/" + '02_OtherEntities'
...
def seve_neo4jQuery_svgQ4_otherEntities(request):

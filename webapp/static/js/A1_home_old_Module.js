    ...
    export const InputFormDFG6RadioButtons = document.querySelectorAll('#inputForDFG6Div input[name="inputModeDFG6"]');
    export const ActivityFormRadioButtons = document.querySelectorAll('#activityDiv input[name="activityMode"]');
    export const ActivityFormRadioButtonsDFG6 = document.querySelectorAll('#activityDFG6Div input[name="activityModeDFG6"]');
    ...
    export const InputDivDfg6Container = document.getElementById('inputForDFG6Div');

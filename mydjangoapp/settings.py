...
SECRET_KEY = "django-insecure-wvj^sbx3a^m)rv*knny8jr1p0t05x#)w7p9k%!x5is2+$ym%qr"
...
X_FRAME_OPTIONS = 'SAMEORIGIN'  # Allows iframe embedding from the same origin
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'cekg.project@gmail.com'
EMAIL_HOST_PASSWORD = 'fnsz twjw suhz qhsc'  # Use the app-specific password you generated

export const nextButton2FormSubmit = document.querySelector('#nextButton3Div input[name="nextButton1Mode"]');
 ...
 export    const optionsToShow = JSON.parse(optionsContainer.getAttribute('data-options-b11'));


 export     const optionsContainerDefault = document.getElementById('optionsContainerDefault');
 export    const optionsToShowDefault = JSON.parse(optionsContainerDefault.getAttribute('data-options-default-b11'));
